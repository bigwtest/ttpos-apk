...
class _$BaseInfoImpl implements _BaseInfo {
  ...
  @override
  String toString() {
    return 'BaseInfo(buffet: $buffet, business: $business, cloud: $cloud, company: $company, currency: $currency, systemVersion: $systemVersion, realName: $realName, kitchen: $kitchen)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, buffet, business, cloud, company,
      currency, systemVersion, realName, kitchen);
