...
abstract class $EditSettingModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(name: "remark") String? remark});
}
...
class _$EditSettingModelImpl implements _EditSettingModel {
  const _$EditSettingModelImpl({@JsonKey(name: "remark") this.remark});
  ...
  @override
  String toString() {
    return 'EditSettingModel(remark: $remark)';
  }
