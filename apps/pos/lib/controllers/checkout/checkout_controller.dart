...
class CheckoutController {
  ...
  static Future<void> _openCheckoutDrawer({
    ...
    customDrawerController.openEndDrawer('checkout', {
      ...
      'onOpenCashBox': callbacks.onOpenCashBox,
      'isModuleAvailableMember': callbacks.isModuleAvailableMember,
    });
  }
}
