...
import 'package:pos/api/top_up_list/top_up_re_return.dart';
...
class TopUpReRefundController extends GetxController {
  ...
  final TopUpReReturnAPI _topUpReReturnAPI = TopUpReReturnAPI();

  Future<bool> reReturnOrder() async {
    try {
      final response = await _topUpReReturnAPI.reReturnOrder(
  ...
  void handleReReturnOrder(
    ...
    if (bankCode.isNotEmpty) {
      ...
      dialogController.qrDialog(qrType: 'top_up_re_return');
      return;
    }
    this.returnAmountUuid = returnAmountUuid;
    this.returnOrderUuid = returnOrderUuid;
  ...
  void qrReReturnOrder(String accountName, String accountNo, String bankCode) {
