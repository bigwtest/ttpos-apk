...
class DesksMainController extends GetxController {
  ...
  static Future<void> onEnterDesksRoute({VoidCallback? onEnterDesks}) async {
    ...
    try {
      ...
      Get.rootDelegate.toNamed(
        ...
        parameters: {
          ...
          'h5OrderUuid': data.h5OrderUuid.toString(),
        },
      );
    } catch (error, stackTrace) {
      debugPrint('DesksMainController toDeskOrderView Error: $error');
  ...
  static Future<void> toDeskListView() async {
    try {
      ...
      debugPrint('DesksMainController toDeskListView Error: $error');
      debugPrintStack(stackTrace: stackTrace);
    }
  }
  ...
  static Future<void> backDeskListView({bool immediate = true}) async {
    try {
      ...
      debugPrint('DesksMainController backDeskListView Error: $error');
      debugPrintStack(stackTrace: stackTrace);
    }
  }
  ...
  static Future<void> saveDeskInfoToStorage(DeskStorageModel data) async {
    try {
      ...
      debugPrint('DesksMainController saveDeskInfoToStorage Error: $error');
      debugPrintStack(stackTrace: stackTrace);
    }
  }
  ...
  static Future<void> removeDeskInfoFromStorage() async {
    try {
      ...
      debugPrint('DesksMainController removeDeskInfoFromStorage Error: $error');
      debugPrintStack(stackTrace: stackTrace);
    }
  }
  ...
  static Future<DeskStorageModel?> getDeskInfoFromStorage() async {
    try {
      ...
      debugPrint('DesksMainController getDeskInfoFromStorage Error: $error');
      debugPrintStack(stackTrace: stackTrace);
      return null;
    }
  }
