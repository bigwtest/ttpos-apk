...
// 是否重置折扣
  ...
  bool? get isResetDiscount => throw _privateConstructorUsedError; // 购物车
  @JsonKey(name: "shop_cart")
  ResponseCart? get shopCart => throw _privateConstructorUsedError;
...
abstract class $ResponseOrderMergeDeskCopyWith<$Res> {
  ...
  $ResponseCartCopyWith<$Res>? get shopCart;
}
...
class _$ResponseOrderMergeDeskCopyWithImpl<$Res,
  ...
  @pragma('vm:prefer-inline')
  $ResponseCartCopyWith<$Res>? get shopCart {
    if (_value.shopCart == null) {
      return null;
    }

    return $ResponseCartCopyWith<$Res>(_value.shopCart!, (value) {
...
class _$ResponseOrderMergeDeskImpl implements _ResponseOrderMergeDesk {
  _$ResponseOrderMergeDeskImpl(
      ...
      @JsonKey(name: "shop_cart") this.shopCart});
...
// 购物车
  @override
  @JsonKey(name: "shop_cart")
  final ResponseCart? shopCart;

  @override
  String toString() {
    return 'ResponseOrderMergeDesk(isResetDiscount: $isResetDiscount, shopCart: $shopCart)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, isResetDiscount, shopCart);
...
abstract class _ResponseOrderMergeDesk implements ResponseOrderMergeDesk {
  factory _ResponseOrderMergeDesk(
          ...
          @JsonKey(name: "shop_cart") final ResponseCart? shopCart}) =
      _$ResponseOrderMergeDeskImpl;
...
// 是否重置折扣
  @override
  @JsonKey(name: "is_reset_discount")
  bool? get isResetDiscount; // 购物车
  @override
  @JsonKey(name: "shop_cart")
  ResponseCart? get shopCart;
