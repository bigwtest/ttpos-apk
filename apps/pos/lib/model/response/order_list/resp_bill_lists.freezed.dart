...
RespBillLists _$RespBillListsFromJson(Map<String, dynamic> json) {
  return _RespBillLists.fromJson(json);
}

/// @nodoc
mixin _$RespBillLists {
  ...
  /// Serializes this RespBillLists to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RespBillLists
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RespBillListsCopyWith<RespBillLists> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RespBillListsCopyWith<$Res> {
  factory $RespBillListsCopyWith(
          RespBillLists value, $Res Function(RespBillLists) then) =
      _$RespBillListsCopyWithImpl<$Res, RespBillLists>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RespBillListsCopyWithImpl<$Res, $Val extends RespBillLists>
    implements $RespBillListsCopyWith<$Res> {
  _$RespBillListsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RespBillListsImplCopyWith<$Res>
    implements $RespBillListsCopyWith<$Res> {
  factory _$$RespBillListsImplCopyWith(
          _$RespBillListsImpl value, $Res Function(_$RespBillListsImpl) then) =
      __$$RespBillListsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "bill_type") int billType,
...
/// @nodoc
class __$$RespBillListsImplCopyWithImpl<$Res>
    extends _$RespBillListsCopyWithImpl<$Res, _$RespBillListsImpl>
    implements _$$RespBillListsImplCopyWith<$Res> {
  __$$RespBillListsImplCopyWithImpl(
      _$RespBillListsImpl _value, $Res Function(_$RespBillListsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RespBillListsImpl(
      billType: null == billType
          ? _value.billType
          : billType // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$RespBillListsImpl implements _RespBillLists {
  _$RespBillListsImpl(
  ...
  factory _$RespBillListsImpl.fromJson(Map<String, dynamic> json) =>
      _$$RespBillListsImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RespBillLists(billType: $billType, consumerUuids: $consumerUuids, extra: $extra, finishTime: $finishTime, isSplit: $isSplit, orderAmount: $orderAmount, orderNo: $orderNo, payTypeName: $payTypeName, paymentAmount: $paymentAmount, saleBillUuid: $saleBillUuid, saleOrderUuid: $saleOrderUuid, saleOrders: $saleOrders, serialNo: $serialNo, status: $status)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RespBillListsImplCopyWith<_$RespBillListsImpl> get copyWith =>
      __$$RespBillListsImplCopyWithImpl<_$RespBillListsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RespBillListsImplToJson(
      this,
    );
  }
}

abstract class _RespBillLists implements RespBillLists {
  factory _RespBillLists(
      ...
      @JsonKey(name: "status")
      required final int status}) = _$RespBillListsImpl;

  factory _RespBillLists.fromJson(Map<String, dynamic> json) =
      _$RespBillListsImpl.fromJson;
