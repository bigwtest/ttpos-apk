...
mixin _$OperationLog {
  @JsonKey(name: "list")
  List<RespRechargeOrderOperationLogItem> get list =>
      throw _privateConstructorUsedError;
  @JsonKey(name: "list")
  set list(List<RespRechargeOrderOperationLogItem> value) =>
      throw _privateConstructorUsedError;
...
abstract class $OperationLogCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "list") List<RespRechargeOrderOperationLogItem> list});
}
    ...
    return _then(_value.copyWith(
      list: null == list
          ...
          : list // ignore: cast_nullable_to_non_nullable
              as List<RespRechargeOrderOperationLogItem>,
    ) as $Val);
  }
}
...
class _$OperationLogImpl implements _OperationLog {
  _$OperationLogImpl({@JsonKey(name: "list") required this.list});
  ...
  @override
  @JsonKey(name: "list")
  List<RespRechargeOrderOperationLogItem> list;
