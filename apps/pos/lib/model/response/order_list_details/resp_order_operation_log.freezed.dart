...
RespOrderOperationLog _$RespOrderOperationLogFromJson(
    Map<String, dynamic> json) {
  return _RespOrderOperationLog.fromJson(json);
}

/// @nodoc
mixin _$RespOrderOperationLog {
  ...
  /// Serializes this RespOrderOperationLog to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of RespOrderOperationLog
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $RespOrderOperationLogCopyWith<RespOrderOperationLog> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RespOrderOperationLogCopyWith<$Res> {
  factory $RespOrderOperationLogCopyWith(RespOrderOperationLog value,
          $Res Function(RespOrderOperationLog) then) =
      _$RespOrderOperationLogCopyWithImpl<$Res, RespOrderOperationLog>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RespOrderOperationLogCopyWithImpl<$Res,
        $Val extends RespOrderOperationLog>
    implements $RespOrderOperationLogCopyWith<$Res> {
  _$RespOrderOperationLogCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RespOrderOperationLogImplCopyWith<$Res>
    implements $RespOrderOperationLogCopyWith<$Res> {
  factory _$$RespOrderOperationLogImplCopyWith(
          _$RespOrderOperationLogImpl value,
          $Res Function(_$RespOrderOperationLogImpl) then) =
      __$$RespOrderOperationLogImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "create_time") int createTime,
...
/// @nodoc
class __$$RespOrderOperationLogImplCopyWithImpl<$Res>
    extends _$RespOrderOperationLogCopyWithImpl<$Res,
        _$RespOrderOperationLogImpl>
    implements _$$RespOrderOperationLogImplCopyWith<$Res> {
  __$$RespOrderOperationLogImplCopyWithImpl(_$RespOrderOperationLogImpl _value,
      $Res Function(_$RespOrderOperationLogImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RespOrderOperationLogImpl(
      createTime: null == createTime
          ? _value.createTime
          : createTime // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$RespOrderOperationLogImpl implements _RespOrderOperationLog {
  _$RespOrderOperationLogImpl(
  ...
  factory _$RespOrderOperationLogImpl.fromJson(Map<String, dynamic> json) =>
      _$$RespOrderOperationLogImplFromJson(json);
  ...
  @override
  String toString() {
    return 'RespOrderOperationLog(createTime: $createTime, description: $description, payType: $payType, refundType: $refundType, source: $source, userEmail: $userEmail, userName: $userName, uuid: $uuid)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RespOrderOperationLogImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RespOrderOperationLogImplCopyWith<_$RespOrderOperationLogImpl>
      get copyWith => __$$RespOrderOperationLogImplCopyWithImpl<
          _$RespOrderOperationLogImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RespOrderOperationLogImplToJson(
      this,
    );
  }
}

abstract class _RespOrderOperationLog implements RespOrderOperationLog {
  factory _RespOrderOperationLog(
          {@JsonKey(name: "create_time") required final int createTime,
          @JsonKey(name: "description") required final String description,
          @JsonKey(name: "pay_type")
          required final List<RespOrderOperationLogPaymentMethod> payType,
          @JsonKey(name: "refund_type") required final int refundType,
  ...
  factory _RespOrderOperationLog.fromJson(Map<String, dynamic> json) =
      _$RespOrderOperationLogImpl.fromJson;
...
class _$RespOrderOperationLogPaymentMethodImpl
  ...
  @override
  String toString() {
    return 'RespOrderOperationLogPaymentMethod(accountName: $accountName, accountNo: $accountNo, bankCode: $bankCode, name: $name, paymentOrderId: $paymentOrderId, price: $price, refundMoney: $refundMoney, refundStatus: $refundStatus, remark: $remark, returnAmountUuid: $returnAmountUuid, returnOrderUuid: $returnOrderUuid, unit: $unit, value: $value)';
  }
