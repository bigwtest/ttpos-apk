...
@freezed
class RequestOrderGiftingProduct with _$RequestOrderGiftingProduct {
  // 私有构造函数，用于添加自定义方法
  const RequestOrderGiftingProduct._();

  const factory RequestOrderGiftingProduct({
    // 销售账单ID
  ...
  }) = _RequestOrderGiftingProduct;

  factory RequestOrderGiftingProduct.fromJson(Map<String, dynamic> json) =>
      _$RequestOrderGiftingProductFromJson(json);
