...
@freezed
class RequestOrderReturningProduct with _$RequestOrderReturningProduct {
  // 私有构造函数，用于添加自定义方法
  const RequestOrderReturningProduct._();

  const factory RequestOrderReturningProduct({
    // 销售账单ID
  ...
  }) = _RequestOrderReturningProduct;

  factory RequestOrderReturningProduct.fromJson(Map<String, dynamic> json) =>
      _$RequestOrderReturningProductFromJson(json);
