...
class AuthAPI {
  ...
  Future<bool> logout({
    ...
    try {
      final response = await _api.postWithRequestOptions(
        APIPath.authLogout.cashierPath,
        requestOptions: requestOptions,
      );
      // 退出成功或需要重新登录
  ...
  Future<bool> verifyAdvancedPassword({
    ...
    try {
      final response = await _api.postWithRequestOptions(
        APIPath.authVerifyAdvancedPassword.cashierPath,
        data: {
          "password": password,
        },
  ...
  Future<bool> verifyCashBoxPassword({
    required String password,
  }) async {
    try {
      final response = await _api.postWithRequestOptions(
        APIPath.authVerifyCashBoxPassword.cashierPath,
        data: {
          "password": password,
        },
        requestOptions: ExtraRequestOptions(
  ...
  Future<bool> verifyLockPassword({
    required String password,
  }) async {
    try {
      final response = await _api.postWithRequestOptions(
        APIPath.authVerifyLockPassword.cashierPath,
        data: {
          "password": password,
        },
        requestOptions: ExtraRequestOptions(
