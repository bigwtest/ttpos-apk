...
class DeskAPI {
  ...
  Future<DeskList?> getDeskList({
    ...
    try {
      final response = await _api.getWithRequestOptions(
        APIPath.deskGetList.cashierPath,
        queryParameters: {
          'status': status,
          'is_buffet': isBuffet,
          ...(meta ??
  ...
  Future<DeskCategory?> getDeskCategory({
    ...
    try {
      final response = await _api.getWithRequestOptions(
        APIPath.deskGetCategory.cashierPath,
        requestOptions: options,
      );
      if (response.code.success) {
        return await response.safeFromJson(
  ...
  Future<Desk?> getDesk(
    ...
    try {
      final response = await _api.getWithRequestOptions(
        APIPath.deskGetInfo.cashierPath,
