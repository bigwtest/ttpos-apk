...
import 'package:menu/model/response/auth/base_info.dart';
...
part 'mixin/menu_mixin.dart';

class BaseInfoController extends GetxController with BaseInfoCompany, BaseInfoCurrency, BaseInfoCloud, BaseInfoMenu {
  //
