...
import 'package:ttpos_ui/components/checkout/views/payment/item.dart';
import 'package:ttpos_ui/components/common/empty_data.dart';
import 'package:ttpos_ui/controllers/font_size_controller.dart';
import 'package:ttpos_ui/theme/theme.dart';

class CheckoutPayment extends StatelessWidget {
  const CheckoutPayment({super.key, required this.tag});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: GetBuilder<CheckoutContainerController>(
              id: tag,
              tag: tag,
              builder: (controller) {
                return Obx(() {
