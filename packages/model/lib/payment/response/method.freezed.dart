...
mixin _$PaymentMethod {
  ...
  SafetyNumber get feePercent => throw _privateConstructorUsedError;
  @JsonKey(name: "logo")
...
abstract class $PaymentMethodCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "fee_percent") SafetyNumber feePercent,
  ...
  $SafetyNumberCopyWith<$Res> get feePercent;
}
...
class _$PaymentMethodCopyWithImpl<$Res, $Val extends PaymentMethod>
  ...
  @pragma('vm:prefer-inline')
  $SafetyNumberCopyWith<$Res> get feePercent {
    return $SafetyNumberCopyWith<$Res>(_value.feePercent, (value) {
      return _then(_value.copyWith(feePercent: value) as $Val);
    });
  }
}
...
class _$PaymentMethodImpl implements _PaymentMethod {
  ...
  @override
  String toString() {
    return 'PaymentMethod(code: $code, feePercent: $feePercent, logo: $logo, paymentName: $paymentName, paymentMethod: $paymentMethod, qrcode: $qrcode, source: $source, sourceText: $sourceText, uuid: $uuid)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, code, feePercent, logo,
      paymentName, paymentMethod, qrcode, source, sourceText, uuid);
...
abstract class _PaymentMethod implements PaymentMethod {
  const factory _PaymentMethod(
      ...
      @JsonKey(name: "fee_percent") required final SafetyNumber feePercent,
