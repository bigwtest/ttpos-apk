library shared_printer_templates_receipt_template2;
...
class ReceiptPrinterTemplate2 extends BasePrinterTemplate {
  @override
  PrinterTemplateName get name => PrinterTemplateName.receipt2;
...
pw.Widget _total(pw.Context context) => pw.Column(
      ...
      children: [
        ...
        text(
          context,
          'VAT (10%): ${'\$ 50.00'.padLeft(12)}',
        ),
        text(
          context,
          'VAT (8%): ${'\$ 50.00'.padLeft(12)}',
        ),
        text(
          context,
